...
set(CPACK_PACKAGE_DESCRIPTION_SUMMARY "C++ server for the McStas simulation")
...
set(CPACK_COMPONENT_${component_runtime}_REQUIRED OFF)
set(CPACK_COMPONENT_${component_development}_REQUIRED OFF)
set(CPACK_COMPONENT_${component_instruments}_REQUIRED ON)

set(CPACK_COMPONENT_${component_server}_REQUIRED ON)

set(CPACK_COMPONENT_${component_development}_DEPENDS ${component_runtime} )
set(CPACK_COMPONENT_${component_runtime}_DEPENDS "" )
set(CPACK_COMPONENT_${component_instruments}_DEPENDS ${component_server})
...
set(CPACK_DEBIAN_${component_instruments}_PACKAGE_DEPENDS "")
set(CPACK_DEBIAN_${component_server}_PACKAGE_DEPENDS "cameo-server (>=1.0.3)")
...
set(CPACK_DEBIAN_${component_server}_PACKAGE_SECTION "science")
set(CPACK_DEBIAN_${component_instruments}_PACKAGE_SECTION "science")
